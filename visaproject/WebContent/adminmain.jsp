...
<body>
	...
	<div style="margin-top: 110px;margin-left:60px" >
		...
		<table  style="height: 200px;width:220px">
				<tr><td><a style="text-decoration: none;font-size: 22px" class="one" href="adminwatch.jsp">Watch</a></td></tr>
		        <tr><td><a style="text-decoration: none;font-size: 22px" class="one" href="admincalendar.jsp">Calendar</a></td></tr>
		        <tr><td><a style="text-decoration: none;font-size: 22px" class="one" href="admincalculate.jsp">Calculate Visa Charge</a></td></tr>
		        <tr><td><a style="text-decoration: none;font-size: 22px" class="one" href="admincontactus.jsp">Contact Us</a></td></tr>
		</table>
    </div>
