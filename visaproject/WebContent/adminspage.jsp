...
<body>
	...
	<table class="table2" >
			<tr class="tr1">
				<th id="th1">ID</th>
				<th id="th1">Name</th>
				<th id="th1">Userame</th>
			</tr>
	
		<%
			PageAdmins user = new PageAdmins();
			ArrayList<User> arrayList = user.getUsers((String)session.getAttribute("username"));
			
			for (User users : arrayList) {
		%>
			<tr class="tr1">
				<td id="td1"><%=users.getId() %></td>
				<td id="td1"><%=users.getName() %></td>
				<td id="td1"><%=users.getUsername() %></td>
			</tr>
			<%
				}
			%>
	...
	<div style="position: absolute;top: 620px;left: 300px">
		...
		<table style="width: 750px;height: 500px;text-align: center">
			<tr>
				<td><p style="font-size: 25px;color: white">Admin Id :</p></td>
				<td>
			...
			<td><p><input id="button" style="background-color: #008CBA" type="submit" value="Remove Admin" ></p></td>
