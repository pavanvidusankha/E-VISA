...
<body>
	...
	<div style="margin-top: 110px;margin-left:60px" >
		...
		<table  style="height: 200px;width:220px">
				<tr><td><a style="text-decoration: none;font-size: 22px" class="one" href="watch.jsp">Watch</a></td></tr>
		        <tr><td><a style="text-decoration: none;font-size: 22px" class="one" href="calendar.jsp">Calendar</a></td></tr>
		        <tr><td><a style="text-decoration: none;font-size: 22px" class="one" href="calculate.jsp">Calculate Visa Charge</a></td></tr>
		        <tr><td><a style="text-decoration: none;font-size: 22px" class="one" href="contactus.jsp">Contact Us</a></td></tr>
		</table>
    </div>
