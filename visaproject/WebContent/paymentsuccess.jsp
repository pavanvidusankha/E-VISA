...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="viewapplyvisa.jsp">View Apply Visa</a>
	...
	<h1 style="margin-left: 105px;font-size: 50px;margin-top: -635px;color: white">Thanks for using eVISA SRI LANKA System !!!</h1>

	<p style="margin-left: 210px;font-size: 30px;margin-top: 20px;width:900px;color:white" ALIGN=CENTER>
		Your payment is successfully completed
		Please check your E-mail to collect your Visa document
		If any compliments occured ,please send a message to admin</p>
