...
<body>
	...
	<h1 style="margin-left: 320px;font-size: 50px;margin-top: -710px">Update Successfully !!!</h1>
	...
	<div style="margin-top: -220px;margin-left: -10px"><span style="font-size:30px;cursor:pointer;position: fixed;margin-top: -10px;" onclick="openNav()"><input type="image" src="scroll.jpg" width="30px"></span></div>
