...
<body>
	...
	<table class="table2" >
		...
		<%
			UserPayments payments = new UserPayments();
			ArrayList<Visa> arrayList = payments.getVisa((String)session.getAttribute("username"));
	...
	<div style="position: absolute;top: 630px;left: 350px">
	
		<form method="POST" action="VisaPayment" >
