...
public ArrayList<Extend> getExtends() {
		...
		try {
			...
			preparedStatement = connection.prepareStatement("select id,user,country,vtype,days,total,ivisa,exvisa,extvisa,extday from payment where extvisa is not null");
