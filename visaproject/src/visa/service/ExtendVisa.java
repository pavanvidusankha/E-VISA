...
public class ExtendVisa {
	
	public ArrayList<Payment> getPayment(String user) {
		...
		try {
			...
			preparedStatement = connection.prepareStatement("select id,user,country,vtype,days,total,ivisa,exvisa from payment where user=? and extvisa is null");
