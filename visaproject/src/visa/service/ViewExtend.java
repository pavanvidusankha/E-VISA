...
public ArrayList<Extend> getExtend(String user) {
		...
		try {
			...
			preparedStatement = connection.prepareStatement("select id,user,country,vtype,days,total,ivisa,exvisa,extvisa,extday from payment where user=? and extvisa is not null");
